...
![Screenshot 1](<Screenshot 2026-07-21 190439.png>)

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![Screenshot 2](<Screenshot 2026-07-21 190804.png>)
...
The .git folder is the hidden directory that stores the information Git needs to manage the repository. It contains the repository's history, configuration, branches, commits, and other metadata. It matters because this folder turns the CodeTrack directory into a Git repository and allows Git to track changes over time.
...
![Screenshot 3](<Screenshot 2026-07-21 191522.png>)
...
![Screenshot 4](<Screenshot 2026-07-21 191528.png>)
